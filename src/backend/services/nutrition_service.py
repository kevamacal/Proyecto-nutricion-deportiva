"""Service layer managing Bioenergetics and Target Calculation domain operations."""
...
class NutritionService:
    """Service handling deterministic BMR/TDEE and macronutrient target calculations."""
