...
export const FoodSelectorModal: React.FC<FoodSelectorModalProps> = ({
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={onClose}
      title="Catálogo de Alimentos e Ingredientes"
      subtitle="Selecciona un alimento para consultar sus aportes macronutricionales por 100g."
          ...
          filteredCatalog.map((food) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ height: '110px', position: 'relative', overflow: 'hidden', width: '100%' }}>
                  <img
                    src={meta.image}
                    alt={food.name}
                    style={{
                ...
                {/* Card Content Body */}
                <div style={{ padding: '0.85rem', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', width: '100%', boxSizing: 'border-box' }}>
                  <div>
